...
declare variable $urilist as xs:string+ := $uri;

declare variable $search-options
  := <options xmlns="http://marklogic.com/appservices/search">
       <searchable-expression xmlns:audit="http://norman.walsh.name/ns/modules/audit">
         { "//audit:http" }
       </searchable-expression>
       <search-option>unfiltered</search-option>
       <constraint name="code">
         <value>
           <element ns="http://norman.walsh.name/ns/modules/audit" name="code"/>
         </value>
       </constraint>
       <constraint name="uri">
         <value>
           <element ns="http://norman.walsh.name/ns/modules/audit" name="uri"/>
         </value>
       </constraint>
       <constraint name="byday">
         <range type="xs:dateTime" facet="true">
           <element ns="http://norman.walsh.name/ns/modules/audit" name="datetime"/>
       ...
       <constraint name="referrer">
         <range type="xs:string" facet="true">
           <element ns="http://norman.walsh.name/ns/modules/audit" name="referrer"/>
       ...
       <constraint name="agent">
         <range type="xs:string" facet="true">
           <element ns="http://norman.walsh.name/ns/modules/audit" name="agent"/>
           <facet-option>frequency-order</facet-option>
...
{ for $ref in $results/search:facet[@name='referrer']/search:facet-value
  where not(contains($ref/@name, '//microwave:84'))
  return
    <dt style="padding-left:20px;text-indent:-20px;">
      <a href="{string($ref/@name)}">{string($ref/@name)}</a> ({string($ref/@count)})
    </dt>
}
</dl>
<h4>Top agents</h4>
...
{ for $ref in $results/search:facet[@name='agent']/search:facet-value
  return
    <dt style="padding-left:20px;text-indent:-20px;">{string($ref/@name)} ({string($ref/@count)})</dt>
}
</dl>
</div>
